...
public class VenueAuthorizationAspectU {
    ...
    private static final String ADD_UPDATE_VENUE_POINTCUT = "execution(* com.example.pnta.Services.Venues.Venue.VenueService.addVenueType(..)) || " +
            "execution(* com.example.pnta.Services.Venues.Venue.VenueService.updateVenue(..))";
    ...
    public Object authorize(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (userId != null && venueId != null && (authorizationService.isUserAdmin(userId)||authorizationService.isUserAssociatedWithVenue(userId,venueId))) {
