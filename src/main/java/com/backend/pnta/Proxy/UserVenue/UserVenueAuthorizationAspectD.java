...
public class UserVenueAuthorizationAspectD {
    ...
    private static final String ADD_UPDATE_VENUE_POINTCUT = "execution(* com.example.pnta.Services.UserVenue.UserVenueService.deleteVenueWorkers(..))";
